 ...
 * all your texture mapping needs. However, this does not involve a more optimal
...
public class JoglTransparencyDemo extends JFrame implements GLEventListener {
	...
	private Texture bkTexture; //The fully opaque background texture
	...
	public void display(GLAutoDrawable drawable) {
		...
		bkTexture.bind(gl); //bind the texture we want to be used
...
//		bkTexture = GLUtils.loadTexture(gl, getClass(), "/rings/SatRing.png", "png", true);
		...
		bkTexture.bind(gl); // only after setting texture properties
