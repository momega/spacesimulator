 ...
 */
public class FullSolarSystemModelBuilder extends AbstractModelBuilder {
    ...
    public void initPlanets() {
        ...
        updateDynamicalPoint(earth, "Earth", 5.97219, 0.997269, 6.378, 23.75);
        ...
        createKeplerianElements(io, jupiter, 421.769 * 1E6, 0.0041, 136.11730, 1.769138, 2456821.035697427578, 0.036, 337.181);
        ...
        createKeplerianElements(europa, jupiter, 671.079 * 1E6, 0.0101, 302.75, 3.551810, 2456822.782242114656, 0.464, 343.685);
        ...
        createKeplerianElements(ganymede, jupiter, 1070.0428 * 1E6, 0.0006, 342.14, 7.154553, 2456819.953914982267, 0.186, 340.928);
        ...
        createKeplerianElements(callisto, jupiter, 1883 * 1E6, 0.007, 263.79, 16.689018, 2456815.215215998702, 0.281, 337.0061);
    ...
    public void initSatellites() {
        ...
        Vector3d velocity = o.getN().scale(14000d);
