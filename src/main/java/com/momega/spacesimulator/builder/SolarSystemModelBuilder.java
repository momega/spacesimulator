...
public class SolarSystemModelBuilder extends SimpleSolarSystemModelBuilder {
    ...
    public void initPlanets() {
        ...
        updateDynamicalPoint(venus, "Venus", 4.8685, 243.0185, 6.0518, 272.76, 67.16);
        ...
        updateDynamicalPoint(mercury, "Mercury", 0.3302, 58.646, 2.4397, 281.01, 61.45);
        ...
        updateDynamicalPoint(jupiter, "Jupiter", 1898.13, 9.925d / 24, 69.911, 268.05, 64.49);
