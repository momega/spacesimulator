...
//
//        KeplerianTrajectory3d earthMoonTrajectory = createKeplerianElements(sun, 149598.261d * 1E6, 0.0166739, 287.5824, 365.256814, 2456661.138788696378, 0.0018601064, 175.395d);
...
//
//        KeplerianTrajectory3d earthTrajectory = createKeplerianElements(earthMoonBarycenter, 4.686955382086d, 0.055557, 264.7609, 27.427302, 2456796.39770, 5.241500, 208.1199);
...
//
//        KeplerianTrajectory3d moonTrajectory = createKeplerianElements(earthMoonBarycenter, 384.399 * 1E6, 0.055557, 84.7609, 27.427302, 2456796.39770989, 5.241500, 208.1199);
...
//
//        KeplerianTrajectory3d marsTrajectory = createKeplerianElements(sun, 227939.1d * 1E6, 0.093315, 286.537, 686.9363, 2457003.918154194020, 1.84844, 49.5147);
...
//
//        KeplerianTrajectory3d venusTrajectory = createKeplerianElements(sun, 108208d * 1E6, 0.0067, 54.6820, 224.699, 2456681.501144, 3.3945, 76.6408);
...
//
//        KeplerianTrajectory3d mercuryTrajectory = createKeplerianElements(sun, 57909.05d * 1E6, 0.20563, 29.124, 87.96890, 2456780.448693044949, 7.0, 48.313);
...
//
//        KeplerianTrajectory3d jupiterTrajectory = createKeplerianElements(sun, 778547.2d * 1E6, 0.048775, 274.008653, 4332.59, 2455638.655976880342, 1.303541, 100.5118);
...
//        io.setTrajectory(createKeplerianElements(jupiter, 421.769 * 1E6, 0.0041, 136.11730, 1.769138, 2456821.035697427578, 0.036, 337.181));
...
//        europa.setTrajectory(createKeplerianElements(jupiter, 671.079 * 1E6, 0.0101, 302.75, 3.551810, 2456822.782242114656, 0.464, 343.685));
...
//        ganymede.setTrajectory(createKeplerianElements(jupiter, 1070.0428 * 1E6, 0.0006, 342.14, 7.154553, 2456819.953914982267, 0.186, 340.928));
...
//        callisto.setTrajectory(createKeplerianElements(jupiter, 1883 * 1E6, 0.007, 263.79, 16.689018, 2456815.215215998702, 0.281, 337.0061));
...
//        phobos.setTrajectory(createKeplerianElements(mars, 9.3772 * 1E6, 0.0151, 121.451, 0.319, 2456821.639245583210, 1.082, 82.446));
...
//        deimos.setTrajectory(createKeplerianElements(mars, 23.4632 * 1E6, 0.00033, 306.201, 1.263, 2456821.036168867722, 1.791, 78.74157));
...
//        SphereOfInfluence earthSoi = addPlanetToSoiTree(earth, sunSoi, (KeplerianElements) earthMoonBarycenter.getTrajectory());
