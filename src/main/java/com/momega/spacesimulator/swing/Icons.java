...
public final class Icons {
    ...
    public static final ImageIcon END_MANEUVER_POINT = SwingUtils.createImageIcon("/images/Math-greater-than-icon.png");
    ...
    public static final ImageIcon SPACECRAFT1 = SwingUtils.createImageIcon("/images/Number-1-icon.png");
}
